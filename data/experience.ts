...
export const experience: ExperienceItem[] = [
  {
    ...
    company: {
      en: 'Outsourcing Fintech',
      ru: 'Аутсорсинг, fintech',
    },
    role: {
  ...
  },
  {
    ...
    description: {
      en: 'Side projects: EcoTrackr, VisaGuide, Lockbox, and the @ecotrackr/co2-calculator npm package.',
      ru: 'Side-проекты: EcoTrackr, VisaGuide, Lockbox и npm-пакет @ecotrackr/co2-calculator.',
    },
    achievements: [
      {
      ...
      {
        en: 'Published @ecotrackr/co2-calculator npm package',
        ru: 'Опубликовала npm-пакет @ecotrackr/co2-calculator',
      },
      {
